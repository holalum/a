"""
GET  /balance          — баланс + история транзакций
POST /balance/promo    — применить промокод
POST /balance/topup    — создать ссылку на оплату (заглушка)
"""
...
async def topup(
    ...
    # TODO: интегрировать платёжный шлюз (Telegram Stars / ЮKassa / и т.д.)
